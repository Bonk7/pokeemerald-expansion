...
3. Het controleert of `overworld.png` 192x32 pixels is, met zes frames van 32x32.
...
De registratie is bedoeld voor Pokemonmappen zoals `graphics/pokemon/meloetta` en `graphics/pokemon/celebi`.
